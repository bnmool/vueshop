      ...
      <el-table :data="userList" border stripe>
        ...
        <el-table-column label="操作" width="180px">
          <template slot-scope="scope">
            <!-- 修改 -->
            <el-tooltip effect="dark" :enterable="disabled" content="修改" placement="bottom-end">
              <el-button
                type="primary"
                icon="el-icon-edit"
                size="mini"
            ...
            <!-- 删除 -->
            <el-tooltip effect="dark" :enterable="disabled" content="删除" placement="bottom-end">
              <el-button
            ...
            <!-- 设置 -->
            <el-tooltip effect="dark" :enterable="disabled" content="设置" placement="bottom-end">
