<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 步骤条 -->
      <el-steps simple :space="200" :active="activeIndex-0" finish-status="success" align-center>
      ...
      >
        ...
        >
          ...
          <el-tab-pane name="3" label="商品图片">
            <!-- action 表示图片要上传到的地址 -->
            <!-- 上传没有设置 token 所以要用 headers 绑定 Authorization 设置 token -->
            <el-upload
              :action="uploadURL"
  ...
  methods: {
    ...
    add() {
      this.$refs.addFormRef.validate(async valid => {
        ...
        // 执行添加的业务逻辑
        // 使用lodash包 cloneDeep(obj) 深拷贝 addForm
